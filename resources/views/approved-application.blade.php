...
<body>
    <div class="card">
        ...
        <div class="content">
            <p>Hi&nbsp;,{{ $user->fname }}</p>
            <p>Thank you for using Online Special Permit Application System (OSPAS). Your application for <strong>{{$permit_type}}</strong> has beedn <strong>APPROVED</strong>. To proceed with the next transaction, please click:
            </p>
