...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('permit_application_discounts', function (Blueprint $table) {
            $table->id();
            // $table->foreignId('special_permit_application_id')->nullable()->constrained();

            $table->unsignedBigInteger('special_permit_application_id');
            $table->foreign('special_permit_application_id', 'application_id')
            ...
            $table->string('status')->nullable(); // pending, approve
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('permit_application_discounts');
    }
};
